...
public class W extends Letters {
    ...
    public W(String size, int r, int g, int b,String font){
        super.setSize(size);
    ...
    @Override
    public void anim(){
        TranslateTransition w = new TranslateTransition();
        w.setNode(super.getLabel());
        w.setCycleCount(TranslateTransition.INDEFINITE);
        w.setByX(5);
