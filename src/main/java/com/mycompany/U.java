 ...
 * @author Andrew
 */
public class U extends Letters {
    
    public U(String size, int r, int g, int b,String font){
        super.setSize(size);
    ...
    @Override
    public void anim(){
        TranslateTransition u = new TranslateTransition();
        u.setNode(super.getLabel());
        u.setCycleCount(TranslateTransition.INDEFINITE);
        u.setByX(5);
